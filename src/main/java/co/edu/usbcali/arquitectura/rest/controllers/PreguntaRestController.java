...
public class PreguntaRestController {
    ...
    @GetMapping(value = "/realizarPregunta/{msjPregunta}")
    public String consultarRespuesta(@PathVariable("msjPregunta")
    String msjPregunta) throws Exception{
    	
    	String mensaje = "";
    	try {
    		mensaje = preguntaLogic.preguntaResponde(msjPregunta);
    		return mensaje;
		} catch (Exception e) {
